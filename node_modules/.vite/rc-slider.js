...
var useStepQueue_default = function(status, callback) {
  var _React$useState = React9.useState(STEP_NONE), _React$useState2 = _slicedToArray(_React$useState, 2), step = _React$useState2[0], setStep = _React$useState2[1];
...
var useDomMotionEvents_default = function(callback) {
  ...
  var onInternalMotionEnd = React10.useCallback(function(event) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React13.forwardRef(function(props, ref) {
    ...
    function getDomElement() {
      try {
        return findDOMNode2(nodeRef.current || wrapperNodeRef.current);
      } catch (e) {
        return null;
      }
    }
    ...
    var originRef = (0, import_react13.useRef)(ref);
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component4 = component || React14.Fragment;
        var motionProps = {};
        ...
        return React14.createElement(Component4, restProps, keyEntities.map(function(_ref2) {
...
var utils4 = {
  ...
  merge: function merge() {
    ...
    for (var i = 0; i < arguments.length; i++) {
      utils4.mix(ret, i < 0 || arguments.length <= i ? void 0 : arguments[i]);
    }
    return ret;
  },
  viewportWidth: 0,
...
mix(utils4, domUtils);
var getParent2 = utils4.getParent;
function getOffsetParent(element) {
  if (utils4.isWindow(element) || element.nodeType === 9) {
    return null;
  }
  var doc = utils4.getDocument(element);
  var body = doc.body;
  var parent;
  var positionStyle = utils4.css(element, "position");
  ...
  for (parent = getParent2(element); parent && parent !== body && parent.nodeType !== 9; parent = getParent2(parent)) {
    positionStyle = utils4.css(parent, "position");
...
var getParent$1 = utils4.getParent;
function isAncestorFixed(element) {
  ...
  for (parent = getParent$1(element); parent && parent !== body && parent !== doc; parent = getParent$1(parent)) {
    var positionStyle = utils4.css(parent, "position");
...
function getVisibleRectForElement(element, alwaysByViewport) {
  ...
  var documentElement = doc.documentElement;
  while (el) {
    if ((navigator.userAgent.indexOf("MSIE") === -1 || el.clientWidth !== 0) && el !== body && el !== documentElement && utils4.css(el, "overflow") !== "visible") {
      var pos = utils4.offset(el);
  ...
  if (!utils4.isWindow(element) && element.nodeType !== 9) {
    ...
    var position = utils4.css(element, "position");
    if (position === "absolute") {
      element.style.position = "fixed";
    }
  }
  var scrollX = utils4.getWindowScrollLeft(win);
  var scrollY = utils4.getWindowScrollTop(win);
  var viewportWidth = utils4.viewportWidth(win);
  var viewportHeight = utils4.viewportHeight(win);
...
function adjustForViewport(elFuturePos, elRegion, visibleRect, overflow) {
  var pos = utils4.clone(elFuturePos);
  var size = {
  ...
  return utils4.mix(pos, size);
}
function getRegion(node) {
  var offset2;
  var w;
  var h;
  if (!utils4.isWindow(node) && node.nodeType !== 9) {
    offset2 = utils4.offset(node);
    w = utils4.outerWidth(node);
    h = utils4.outerHeight(node);
  } else {
    var win = utils4.getWindow(node);
    offset2 = {
      left: utils4.getWindowScrollLeft(win),
      top: utils4.getWindowScrollTop(win)
    };
    w = utils4.viewportWidth(win);
    h = utils4.viewportHeight(win);
  }
  offset2.width = w;
  offset2.height = h;
  return offset2;
...
function doAlign(el, tgtRegion, align, isTgtRegionVisible) {
  ...
  var newElRegion = utils4.merge(elRegion, elFuturePos);
  if (visibleRect && (overflow.adjustX || overflow.adjustY) && isTgtRegionVisible) {
    ...
    if (fail) {
      ...
      utils4.mix(newElRegion, elFuturePos);
    }
  ...
  if (newElRegion.width !== elRegion.width) {
    utils4.css(source, "width", utils4.width(source) + newElRegion.width - elRegion.width);
  }
  if (newElRegion.height !== elRegion.height) {
    utils4.css(source, "height", utils4.height(source) + newElRegion.height - elRegion.height);
  }
  utils4.offset(source, {
...
var RefAlign = import_react15.default.forwardRef(Align);
RefAlign.displayName = "Align";
var Align_default = RefAlign;
...
var useStretchStyle_default = function(stretch) {
  ...
  var style2 = React18.useMemo(function() {
    var sizeStyle = {};
    if (stretch) {
...
// node_modules/rc-trigger/es/Popup/PopupInner.js
var PopupInner = React19.forwardRef(function(props, ref) {
  ...
  if (React19.Children.count(children) > 1) {
    childNode = React19.createElement("div", {
      className: "".concat(prefixCls, "-content")
    }, children);
  }
  return React19.createElement(es_default, _extends({
    visible,
    ref: elementRef,
    ...
    return React19.createElement(es_default2, {
...
var MobilePopupInner = React20.forwardRef(function(props, ref) {
...
// node_modules/rc-trigger/es/Popup/index.js
var Popup = React21.forwardRef(function(_ref, ref) {
  ...
  var popupNode = inMobile ? React21.createElement(MobilePopupInner_default, _extends({}, cloneProps, {
    mobile,
    ref
  })) : React21.createElement(PopupInner_default, _extends({}, cloneProps, {
    ref
  }));
  return React21.createElement("div", null, React21.createElement(Mask, cloneProps), popupNode);
});
...
function generateTrigger(PortalComponent) {
  var Trigger = function(_React$Component) {
    ...
    function Trigger2(props) {
      ...
      _this = _super.call(this, props);
      _this.popupRef = React23.createRef();
      _this.triggerRef = React23.createRef();
      ...
      _this.getComponent = function() {
        ...
        return React23.createElement(Popup_default, _extends({
          prefixCls,
          destroyPopupOnHide,
    ...
    _createClass(Trigger2, [{
      ...
      value: function render() {
        ...
        var trigger = React23.cloneElement(child, cloneProps);
        var portal;
        if (popupVisible || this.popupRef.current || forceRender) {
          portal = React23.createElement(PortalComponent, {
            key: "portal",
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  var getPopupElement = function getPopupElement2() {
    ...
    return [React25.createElement("div", {
      ...
      key: "arrow"
    }, arrowContent), React25.createElement(Content_default, {
      key: "content",
      prefixCls,
      id,
      overlay,
  ...
  return React25.createElement(es_default3, _extends({
...
// node_modules/rc-slider/es/common/SliderTooltip.js
var SliderTooltip = React26.forwardRef(function(props, ref) {
  var visible = props.visible, overlay = props.overlay;
  var innerRef = React26.useRef(null);
  var tooltipRef = composeRef(ref, innerRef);
  var rafRef = React26.useRef(null);
  ...
  return React26.createElement(es_default4, _extends({
    ref: tooltipRef
  }, props));
});
