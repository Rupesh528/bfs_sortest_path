...
// node_modules/reactive-button/dist/index.esm.js
...
function o(t2, e2) {
  return function(t3) {
    ...
    if (typeof Symbol == "undefined" || !(Symbol.iterator in Object(t3)))
      return;
    var n2 = [], o2 = true, r2 = false, a2 = void 0;
    try {
      for (var i2, c2 = t3[Symbol.iterator](); !(o2 = (i2 = c2.next()).done) && (n2.push(i2.value), !e3 || n2.length !== e3); o2 = true)
        ;
    } catch (t4) {
      r2 = true, a2 = t4;
    } finally {
      try {
        o2 || c2.return == null || c2.return();
      } finally {
        if (r2)
          throw a2;
      }
...
var a = import_react.default.createElement("svg", { "aria-hidden": "true", focusable: "false", "data-prefix": "fas", "data-icon": "spinner", className: "reactive-btn-loading-svg reactive-spin", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, import_react.default.createElement("path", { fill: "currentColor", d: "M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z" }));
var i = import_react.default.createElement("svg", { "aria-hidden": "true", focusable: "false", "data-prefix": "fas", "data-icon": "check", className: "reactive-btn-success-svg", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, import_react.default.createElement("path", { fill: "currentColor", d: "M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z" }));
var c = import_react.default.createElement("svg", { "aria-hidden": "true", focusable: "false", "data-prefix": "fas", "data-icon": "times", className: "reactive-btn-error-svg", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 352 512" }, import_react.default.createElement("path", { fill: "currentColor", d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" }));
function index_esm_default(r2) {
  var l = r2.color ? r2.color : "primary", b = r2.idleText ? r2.idleText : "Click Me", s = r2.loadingText && r2.loadingText !== "" ? r2.loadingText : "Loading", v = r2.successText && r2.successText !== "" ? r2.successText : "Success", d = r2.errorText && r2.errorText !== "" ? r2.errorText : "Error", u = r2.type ? r2.type : "button", p = "reactive-btn".concat(r2.className ? " " + r2.className : ""), x = !!r2.outline, g = !!r2.shadow, h = r2.style ? r2.style : {}, w = !!r2.rounded, m = r2.size ? r2.size : "normal", y = r2.animation === void 0 || r2.animation !== false, k = o((0, import_react.useState)(r2.buttonState ? r2.buttonState : "idle"), 2), f = k[0], z = k[1];
  (0, import_react.useEffect)(function() {
    r2.buttonState !== void 0 && (z(r2.buttonState), r2.buttonState !== "success" && r2.buttonState !== "error" || setTimeout(function() {
      z("idle");
    }, r2.messageDuration ? r2.messageDuration : 2e3));
  }, [r2.buttonState, r2.messageDuration]);
  var E;
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("span", { className: "reactive-btn-wrapper ".concat(m).concat(r2.block ? " block" : ""), style: { width: r2.width, height: r2.height } }, import_react.default.createElement("button", { ref: r2.buttonRef !== void 0 ? r2.buttonRef : null, disabled: f !== "idle" || r2.disabled, "data-button-state": f, type: u, className: "".concat(p, " ").concat(l).concat(x ? " outline" : "").concat(y ? "" : " no-animation").concat(w ? " rounded" : "").concat(g ? " shadow" : "").concat(r2.disabled ? " disabled" : ""), onClick: function() {
    r2.onClick !== void 0 && r2.onClick();
  }, style: h }, import_react.default.createElement("span", { className: "progress" }), import_react.default.createElement("span", { className: "content" }, import_react.default.createElement(import_react.default.Fragment, null, (E = f) === "idle" ? b : E === "loading" ? s === "Loading" ? import_react.default.createElement(import_react.default.Fragment, null, a, " ", s) : s : E === "success" ? v === "Success" ? import_react.default.createElement(import_react.default.Fragment, null, i, " ", v) : v : E === "error" ? d === "Error" ? import_react.default.createElement(import_react.default.Fragment, null, c, " ", d) : d : void 0)))));
}

// dep:reactive-button
var reactive_button_default = index_esm_default;
export {
  reactive_button_default as default
};
